...
INCLUDES := $(INCLUDES) -I $(PDIR)include -I $(PDIR)include/driver -I $(PDIR)include/mqtt -I $(PDIR)include/ssl -I $(PDIR)libesphttpd/include -I $(PDIR)libesphttpd/espfs
#sinclude $(SDK_PATH)/Makefile
sinclude $(SDK_PATH)/forWindows.mk
